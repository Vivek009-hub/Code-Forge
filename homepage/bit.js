const questions = [
    {
        question: "In a continuous-time signal, what is the main function of the Fourier Transform?",
        choices: ["To convert the time-domain signal into a frequency-domain signal", "To filter noise from the signal", "To convert the signal into a discrete form", "To calculate the derivative of the signal"],
        correct: 0,
    },
    {
        question: "In a digital circuit, the Boolean expression A'B+AB' represents which of the following logic gates?",
        choices: ["AND Gate", "OR Gate", " XOR Gate", "NAND Gate"],
        correct: 2,
    },
    {
        question: "Which of the following is NOT a type of software development methodology?",
        choices: ["Agile", "Waterfall", "V-Model", "SQL"],
        correct: 3, 
    },
    {
        question: "In electrical engineering, the power factor of an ideal resistor is:",
        choices: ["1", "0", "Infinity", "1.5"],
        correct: 0,
    },
    {
        question: "The Z-transform of a sequence x[n]=1^n for n>=0 is:",
        choices: ["1/(1-z)", "1/(1+z)", "z/(1-z)", "z/(1+z)"],
        correct: 0,
    },{
